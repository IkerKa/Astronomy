...
# calculamos primera aceleracion
positions = []
...
plt.xlabel('x (m)')
plt.ylabel('y (m)')
plt.title('Órbita usando método de Verlet')
plt.legend()
plt.grid()
plt.show()
...
# np.savetxt('orbita_verlet.txt', positions, header='x y', comments='')

anios = 10000
tiempo = elapsed_time
filename = 'tiempo_verlet.csv'
